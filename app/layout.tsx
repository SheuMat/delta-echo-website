...
export const metadata: Metadata = {
  ...
  title: {
    default: `${SITE_CONFIG.name} | Compassionate Home Care Across Nottinghamshire & Derbyshire`,
  ...
  openGraph: {
    ...
    title: `${SITE_CONFIG.name} | Compassionate Home Care Across Nottinghamshire & Derbyshire`,
    description: SITE_CONFIG.description,
    images: [
      {
...
const jsonLd = {
  ...
  areaServed: [
    { '@type': 'City', name: 'Derby city' },
    { '@type': 'City', name: 'Ilkeston' },
    { '@type': 'City', name: 'Belper' },
    { '@type': 'City', name: 'Ripley' },
    { '@type': 'City', name: 'Alfreton' },
    { '@type': 'City', name: 'Kirkby in Ashfield' },
    { '@type': 'City', name: 'Sutton in Ashfield' },
    { '@type': 'City', name: 'Long Eaton' },
    { '@type': 'City', name: 'Heanor' },
    { '@type': 'City', name: 'Borrowash' },
    { '@type': 'City', name: 'Draycott' },
    { '@type': 'City', name: 'Nottingham' },
    { '@type': 'City', name: 'Hucknall' },
    { '@type': 'City', name: 'Beeston' },
    { '@type': 'City', name: 'West Bridgford' },
    { '@type': 'City', name: 'Clifton' },
    { '@type': 'City', name: 'Gedling' },
    { '@type': 'City', name: 'Arnold' },
    { '@type': 'City', name: 'Wollaton' },
    { '@type': 'City', name: 'Broxtowe' },
    { '@type': 'City', name: 'Rushcliffe' },
