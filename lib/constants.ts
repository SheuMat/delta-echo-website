export const SITE_CONFIG = {
  ...
  tagline: 'Compassionate Home Care in Nottinghamshire',
  description:
    'DeltaEcho Care Ltd provides reliable, CQC-registered domiciliary and live-in care across Nottinghamshire. Person-centred support for older people and adults with care needs.',
  phone1: '07883 024345',
  phone2: '07782 500126',
...
export const TRUST_ITEMS = [
  ...
  { label: 'Local Nottinghamshire Team', icon: 'map-pin' },
